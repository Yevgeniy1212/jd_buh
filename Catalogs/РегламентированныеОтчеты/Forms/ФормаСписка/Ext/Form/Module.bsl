...
Функция ПолучитьОтчет()
	...
	Если НЕ ТекущийОтчет.ВнешнийОтчетИспользовать Тогда
		...
		Иначе 								
			...
			Исключение
				ТекстОшибки = НСтр("ru = 'Не удалось запустить внешний отчет'");
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(Список, "Внешний", 
						НСтр("ru = 'Внешний'"));     
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(Список, "Встроенный", 
						НСтр("ru = 'Встроенный'"));     											
КонецПроцедуры

...
Функция ЗаписатьЭлементСправочника(КодЭлемента, НаименованиеЭлемента)	
	...
	Исключение
		...
		ТекстСообщения = НСтр("ru='Не удалось записать элемент: %1 %2 '")+ Символы.ПС + ОписаниеОшибки();
		ОбщегоНазначения.СообщитьПользователю(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ТекстСообщения, КодЭлемента, НаименованиеЭлемента),,,,);

...
Функция ТекстПредупрежденияНеобходимоНастроитьУчетнуюЗапись()
	...
	ТекстПредупрежденияФорматированнаяСтрока = СтроковыеФункции.ФорматированнаяСтрока(
		НСтр("ru = 'Для отправки отчета настройте <a href=""%1"">учетную запись электронной почты</a>'"),
		"НастроитьУчетнуюЗапись");
 	
	Возврат ТекстПредупрежденияФорматированнаяСтрока;

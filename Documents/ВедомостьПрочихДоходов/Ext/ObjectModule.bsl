...
Процедура ЗаполнитьНаборыЗначенийДоступа(Таблица) Экспорт
	...
	СписокФизЛиц = Выплаты.ВыгрузитьКолонку("ФизЛицо");;
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если СпособВыплаты <> Перечисления.СпособыВыплатыЗарплаты.ЧерезБанк Тогда		
		...
		МассивНепроверяемыхРеквизитов.Добавить("Выплаты.НомерСчета");
	КонецЕсли;
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	МассивТЧ.Добавить(Выплаты);
	
	// подразделение планируется использовать в последующем при реализации произвольных выплат, на момент реализации данный реквизит не используется
	...
	СуммаДокумента = Выплаты.Итог("СуммаКВыплате");

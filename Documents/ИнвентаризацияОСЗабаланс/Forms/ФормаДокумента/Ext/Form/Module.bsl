...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	Если ИсточникВыбора.ИмяФормы = "Справочник.ФизическиеЛица.Форма.ФормаВыбора" Тогда 
		...
		Если СтрокаТабличнойЧасти.Количество() <> 0 Тогда
			...
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстСообщения, , "ИнвентаризационнаяКомиссия[" + Элементы.ИнвентаризационнаяКомиссия.ТекущаяСтрока + "].ФизЛицо", "Объект");
...
Процедура ЗаполнитьДанныеУчетаНаСервере()
	...
	Документы.ИнвентаризацияОСЗабаланс.ЗаполнитьТабличнуюЧастьОС(Объект,ПоддержкаРаботыСоСтруктурнымиПодразделениями, "ПоДаннымУчета");
...
Процедура ЗаполнитьПоОстаткамНаСервере()
	...
	Документы.ИнвентаризацияОСЗабаланс.ЗаполнитьТабличнуюЧастьОС(Объект,ПоддержкаРаботыСоСтруктурнымиПодразделениями, "ПоОстаткам");
...
&НаСервере
Процедура ЗаполнитьПоОстаткамНаСервереЗабаланс()
	
	Документы.ИнвентаризацияОСЗабаланс.ЗаполнитьТабличнуюЧастьОС(Объект,ПоддержкаРаботыСоСтруктурнымиПодразделениями, "ПоЗабалансовым");
...
&НаКлиенте
Процедура ЗаполнитьПоЗабалансовым(Команда)
	...
	ЗаполнитьПоОстаткамНаСервереЗабаланс();

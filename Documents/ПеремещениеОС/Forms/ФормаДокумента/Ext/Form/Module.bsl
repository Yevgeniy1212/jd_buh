...
//Евгений+
&НаКлиенте
Процедура СолидарноеМолСтрока1ПриИзменении(Элемент)
	Объект.СолидарныеМол1.Очистить();
	Для каждого текЗначение из СолидарноеМолСтрока1 цикл
		новСтрока = Объект.СолидарныеМол1.Добавить();
...
Процедура СолМол()
	...
	Конеццикла;
	СолидарноеМолСтрока1.Очистить();
	Для каждого текСтрока из Объект.СолидарныеМол1 цикл
		СолидарноеМолСтрока1.Добавить(текстрока.ФизЛицо);	
	Конеццикла;
КонецПроцедуры

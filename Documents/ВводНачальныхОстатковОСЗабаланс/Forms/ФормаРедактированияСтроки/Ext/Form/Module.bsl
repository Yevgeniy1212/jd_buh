...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	//
	Элементы.СчетУчетаБУ.СписокВыбора.Добавить(ПланыСчетов.Типовой.АрендованныеОсновныеСредства,ПланыСчетов.Типовой.АрендованныеОсновныеСредства.Код +  " (" +ПланыСчетов.Типовой.АрендованныеОсновныеСредства.Наименование + ")" );
	...
	Если ПланыСчетов.Типовой.НайтиПоКоду("9040") <> ПланыСчетов.Типовой.ПустаяСсылка() Тогда
		Элементы.СчетУчетаБУ.СписокВыбора.Добавить(ПланыСчетов.Типовой.НайтиПоКоду("9040"), сч9040.Код + " (" + сч9040.Наименование + ")");
	КонецЕсли;

...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	ОбщегоНазначенияБКВызовСервера.ДобавитьКолонкуВТаблицуЗначений(ПараметрыПроведения.ОприходованиеТоваровТаблицаТовары, "Содержание", НСтр("ru = 'Оприходование ТМЗ'", ОбщегоНазначения.КодОсновногоЯзыка()));
	ОбщегоНазначенияБКВызовСервера.ДобавитьКолонкуВТаблицуЗначений(ПараметрыПроведения.ОприходованиеТоваровРеквизиты, "НомерЖурнала", НСтр("ru = 'ОС'", ОбщегоНазначения.КодОсновногоЯзыка()));   	

...
Процедура Приостановить(Команда)
	...
	ТекстВопроса = НСтр("ru = 'Остановка дополнительных процедур обработки данных'") + Символы.ПС +
		НСтр("ru = 'может привести к нестабильной работе или неработоспособности программы.'") + Символы.ПС +
		НСтр("ru = 'Выполнять отключение рекомендуется в случае обнаружения ошибки'") + Символы.ПС +
		НСтр("ru = 'в процедуре обработки данных и только после консультации со службой поддержки,'") + Символы.ПС +
		НСтр("ru = 'т.к. процедуры отработки данных могут зависеть друг от друга.'");
	КнопкиВопроса = Новый СписокЗначений;
	КнопкиВопроса.Добавить("Да", НСтр("ru = 'Остановить'"));
	КнопкиВопроса.Добавить("Нет", НСтр("ru = 'Отмена'"));

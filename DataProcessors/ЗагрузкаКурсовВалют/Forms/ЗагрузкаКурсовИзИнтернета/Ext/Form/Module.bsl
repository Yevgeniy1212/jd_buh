...
Процедура СписокВалютОбработкаВыбора(Элемент, Валюта, СтандартнаяОбработка)
	...
	Если МассивСтрок.Количество() = 0 Тогда
		...
		Иначе
			СтрокаСпискаВалют.ДатаКурса = НСтр("ru = 'Курс отсутствует'");
		КонецЕсли;
...
Функция СообщитьНачатаЗагрузкаКурсов()
	...
	#Если ТолстыйКлиентОбычноеПриложение Тогда
		ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр("ru = 'Выполняется загрузка курсов валют...'"));
	#Иначе
		Состояние(НСтр("ru = 'Выполняется загрузка курсов валют...

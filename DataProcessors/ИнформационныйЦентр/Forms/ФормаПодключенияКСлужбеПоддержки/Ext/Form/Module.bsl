...
Процедура ЗаполнитьСписокПользователейИБ()
	...
	//БК3. Нет п/с КонтактнаяИнформация
	Запрос = Новый Запрос;
	Запрос.Текст = "ВЫБРАТЬ 
	|	Пользователи.Ссылка КАК Пользователь,    
	|	ПОДСТРОКА(ПользователиКонтактнаяИнформация.Представление, 1, 1000) КАК Email,
    ...
    |ГДЕ
	|	НЕ Пользователи.Ссылка.Недействителен
	|	И НЕ Пользователи.Ссылка.Служебный ";

...
Процедура НачатьВыполнениеЗагрузки(Результат, Параметры) Экспорт
    ...
    ВыполнитьЗагрузкуНаСервере(АдресХранения, Объект.Организация, Объект.ПодразделениеОрганизации, Лист,ПерваяСтрока, ПоследняяСтрока, 
                                     Объект.ДатаПринятияКУчету);
     
КонецПроцедуры

&НаКлиенте
Процедура ВыполнитьЗагрузкуНаСервере(АдресХранения, Организация, ПодразделениеОрганизации, Лист, ПерваяСтрока, ПоследняяСтрока, ДатаПринятияКУчету)

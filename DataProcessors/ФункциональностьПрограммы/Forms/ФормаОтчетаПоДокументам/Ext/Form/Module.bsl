...
Процедура ОтобразитьОшибкуФормированияОтчета(ПолеРезультат, ОписаниеОшибки)
	...
	ШаблонИнформации = НСтр("ru = 'Ошибка при формировании отчета:'") + Символы.ПС +
                             НСтр("ru = '%1'") + Символы.ПС +
							 НСтр("ru = 'Детальная информация записана в журнал регистрации.'");
	
	ИнформацияДляПользователя = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ШаблонИнформации, ОписаниеОшибки);

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокСкорость.Добавить(1,     НСтр("ru='300 бод'"));
	СписокСкорость.Добавить(2,     НСтр("ru='600 бод'"));
	СписокСкорость.Добавить(3,    НСтр("ru='1200 бод'"));
	СписокСкорость.Добавить(4,    НСтр("ru='2400 бод'"));
	СписокСкорость.Добавить(5,    НСтр("ru='4800 бод'"));
	СписокСкорость.Добавить(7,    НСтр("ru='9600 бод'"));
	СписокСкорость.Добавить(10,  НСтр("ru='19200 бод'"));
	СписокСкорость.Добавить(12,  НСтр("ru='38400 бод'"));
	СписокСкорость.Добавить(14,  НСтр("ru='57600 бод'"));
	СписокСкорость.Добавить(18, НСтр("ru='115200 бод'"));
	...
	СписокБитыДанных.Добавить(3, НСтр("ru='7 бит'"));
	СписокБитыДанных.Добавить(4, НСтр("ru='8 бит'"));
	
	СписокСтопБиты = Элементы.СтопБиты.СписокВыбора;
	СписокСтопБиты.Добавить(0, НСтр("ru='1 бит'"));
	СписокСтопБиты.Добавить(2, НСтр("ru='2 бита'"));
...
Процедура ОбновитьДоступныеПорты()
	...
	Для Индекс = 1 По 64 Цикл
		СписокПорт.Добавить(Индекс, СтрШаблон(НСтр("ru='COM%1'"), СокрЛП(Индекс)));
	КонецЦикла;

	Если Число(Модель) = 7 Тогда
		СписокПорт.Добавить(65,  НСтр("ru='USB'"));
		СписокПорт.Добавить(101, НСтр("ru='TCP/IP'"));
		СписокПорт.Добавить(102, НСтр("ru='IRComm (клиент)'"));
	ИначеЕсли Число(Модель) = 9 Тогда
		СписокПорт.Добавить(103, НСтр("ru='IRComm (сервер)'"));

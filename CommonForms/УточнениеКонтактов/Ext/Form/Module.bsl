...
Процедура ЗаполнитьТаблицыТекущихEmailКонтактов()
	...
	Для каждого ЭлементМассиваОписания Из МассивОписанияТиповКонтактов Цикл
		...
		|ИЗ
		|	Справочник.ВидыКонтактнойИнформации КАК ВидыКонтактнойИнформации,
		|	Справочник." + ЭлементМассиваОписания.Имя + " КАК ТаблицаКонтактов
		|ГДЕ
...
Процедура ИзменитьКонтактнуюИнформациюДляВыбранных()
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			ЗаписьКонтактнаяИнформация.Объект = Выборка.Контакт;
			...
			ЗаписьКонтактнаяИнформация.Вид = ВидКИ;
			ЗаписьКонтактнаяИнформация.Тип = ТипКИ;
			ЗаписьКонтактнаяИнформация.Представление = СокрЛП(Выборка.Адрес);

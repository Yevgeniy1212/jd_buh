		...
		Если Тип = Тип("Строка") Тогда
			...
			Если ОписаниеТипа.КвалификаторыСтроки.Длина > 0 Тогда
				Если ОписаниеТипа.КвалификаторыСтроки.ДопустимаяДлина = ДопустимаяДлина.Переменная Тогда
					ПредставлениеТипа = СтрШаблон(НСтр("ru = 'строка до %1 символов'"), ОписаниеТипа.КвалификаторыСтроки.Длина);
				Иначе
					ПредставлениеТипа = СтрШаблон(НСтр("ru = 'строка %1 символов'"), ОписаниеТипа.КвалификаторыСтроки.Длина);
				КонецЕсли;
			КонецЕсли;
		...
		ИначеЕсли Тип = Тип("Число") Тогда
			...
			Если ОписаниеТипа.КвалификаторыЧисла.Разрядность > 0 Тогда
				Если ОписаниеТипа.КвалификаторыЧисла.ДопустимыйЗнак = ДопустимыйЗнак.Неотрицательный Тогда
					ПредставлениеТипа = НСтр("ru = 'неотрицательное число формата %1.%2'");
				Иначе
					ПредставлениеТипа = НСтр("ru = 'число формата %1.%2'");
				КонецЕсли;
				ПредставлениеТипа = СтрШаблон(ПредставлениеТипа,
			...
			ИначеЕсли ОписаниеТипа.КвалификаторыЧисла.ДопустимыйЗнак = ДопустимыйЗнак.Неотрицательный Тогда
				ПредставлениеТипа = НСтр("ru = 'неотрицательное число'");
			КонецЕсли;
			
		ИначеЕсли Тип = Тип("Дата") И ДатаПоФорматуФНС Тогда
			ПредставлениеТипа = НСтр("ru = 'дата с 01.01.1900 до 31.12.2099 г.'");
		КонецЕсли;

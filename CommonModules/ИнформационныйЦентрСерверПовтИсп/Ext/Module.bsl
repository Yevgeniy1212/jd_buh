...
Функция ИнформационныеСсылки(ХешПутьКФорме) Экспорт
	...
	// Дополнен запрос для вывода актуальной ссылки из макета ИнформационныеСсылки_Общие, 
	// без дублирования ссылок с одинаковыми наименованиями
	Запрос.Текст = 
	"ВЫБРАТЬ
	...
	|	МАКСИМУМ(ИнформационныеСсылкиДляФорм.ДатаОбновления) КАК ДатаОбновления,
	|	ИнформационныеСсылкиДляФорм.ПолныйПутьКФорме КАК ПолныйПутьКФорме
	|ПОМЕСТИТЬ ИнформационныеСсылки
	|ИЗ
	|	Справочник.ИнформационныеСсылкиДляФорм КАК ИнформационныеСсылкиДляФорм
	|СГРУППИРОВАТЬ ПО
	|	ИнформационныеСсылкиДляФорм.Наименование,
	|	ИнформационныеСсылкиДляФорм.Вес,
	|	ИнформационныеСсылкиДляФорм.ДатаНачалаАктуальности,
	|	ИнформационныеСсылкиДляФорм.ДатаОкончанияАктуальности,
	|	ИнформационныеСсылкиДляФорм.ПолныйПутьКФорме
	|;
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ИнформационныеСсылкиДляФорм.Наименование КАК Наименование,
	...
	|	ИнформационныеСсылкиДляФорм.ПолныйПутьКФорме КАК ПолныйПутьКФорме
	|ПОМЕСТИТЬ ИнформационныеСсылкиДляФорм
	|ИЗ
	|	Справочник.ИнформационныеСсылкиДляФорм КАК ИнформационныеСсылкиДляФорм
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ИнформационныеСсылки КАК ИнформационныеСсылки
	|		ПО ИнформационныеСсылкиДляФорм.Наименование = ИнформационныеСсылки.Наименование
	|		И ИнформационныеСсылкиДляФорм.ДатаОбновления = ИнформационныеСсылки.ДатаОбновления
	|;"; 
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ИнформационныеСсылкиДляФорм КАК ИнформационныеСсылкиДляФорм

...
Процедура ПолучитьПланыОбмена(ПланыОбменаПодсистемы) Экспорт
	...
	//Кибернетика Евгений+
	ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.киб_ОбменЗарплата3Бухгалтерия3Кадровый);
    //Кибернетика Евгений-
...
Процедура ПолучитьВерсииФорматаОбмена(УзелИнформационнойБазы, ВерсииФормата) Экспорт
	...
	Если ЗначениеЗаполнено(УзелИнформационнойБазы) И (УзелИнформационнойБазы.ВариантНастройки = "ОбменУНФБП" Или УзелИнформационнойБазы.ВариантНастройки = "ОбменБП30" Или УзелИнформационнойБазы.ВариантНастройки = "ОбменУНФ_БП3") Тогда

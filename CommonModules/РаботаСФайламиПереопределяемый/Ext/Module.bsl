...
Процедура ПриСозданииФормыСпискаФайлов(Форма) Экспорт
	...
	// В БК 3.0 фукционал электронных подписей не используется
	
	МассивЭлементов = Новый Массив;
	МассивЭлементов.Добавить("ФормаГруппаКомандЭлектроннаяПодписьИШифрование");
	МассивЭлементов.Добавить("СписокКонтекстноеМенюГруппаКомандЭлектроннаяПодписьИШифрование");
	МассивЭлементов.Добавить("СписокНомерКартинкиПодписанЗашифрован");
...
Процедура ПриСозданииФормыЭлементаФайлов(Форма) Экспорт
	...
	МассивЭлементов = Новый Массив;
	МассивЭлементов.Добавить("ФормаГруппаКомандЭлектроннаяПодписьИШифрование");
	МассивЭлементов.Добавить("ГруппаЭлектронныеПодписи");
	МассивЭлементов.Добавить("ГруппаСертификатыШифрования");

...
Процедура ПолучитьДанныеВыпискиБанкаТекстовыйФормат(
	...
	Для Каждого СтруктураДанных Из МассивДанных Цикл
		...
		Для Каждого СтрокаТЧ Из СтрокиТЧ Цикл
			...
			ПлательщикКодСтраныРегистрации = ЗначениеРеквизитаСтрокиДереваРазбора(
				ДеревоРазбора, СтрокаТЧ, "ПлательщикКодСтраныРегистрации");
			Если ЗначениеЗаполнено(ПлательщикКодСтраныРегистрации) Тогда
				ДобавитьНеПустойПараметр(ДеревоРазбора, СтрокаТЧ, Текст, "ПлательщикКодСтраныРегистрации", "ПлательщикКодСтраныРегистрации");
			КонецЕсли;
			
			ФактическийПлательщикНаименование = ЗначениеРеквизитаСтрокиДереваРазбора(
				ДеревоРазбора, СтрокаТЧ, "ФактическийПлательщикНаименование");
			Если ЗначениеЗаполнено(ФактическийПлательщикНаименование) Тогда
				ДобавитьНеПустойПараметр(ДеревоРазбора, СтрокаТЧ, Текст, "ФактическийПлательщикНаименование", "ФактическийПлательщикНаименование");
			КонецЕсли;
			
			ФактическийПлательщикИНН = ЗначениеРеквизитаСтрокиДереваРазбора(
				ДеревоРазбора, СтрокаТЧ, "ФактическийПлательщикИНН");
			Если ЗначениеЗаполнено(ФактическийПлательщикИНН) Тогда
				ДобавитьНеПустойПараметр(ДеревоРазбора, СтрокаТЧ, Текст, "ФактическийПлательщикИНН", "ФактическийПлательщикИНН");
			КонецЕсли;
			...
			ПолучательКодСтраныРегистрации = ЗначениеРеквизитаСтрокиДереваРазбора(
				ДеревоРазбора, СтрокаТЧ, "ПолучательКодСтраныРегистрации");
			Если ЗначениеЗаполнено(ПолучательКодСтраныРегистрации) Тогда
				ДобавитьНеПустойПараметр(ДеревоРазбора, СтрокаТЧ, Текст, "ПолучательКодСтраныРегистрации", "ПолучательКодСтраныРегистрации");
			КонецЕсли;
...
Процедура ПеренестиДанныеОбменаСБанками(Параметры) Экспорт
	...
	Попытка
		...
		СоглашениеЭДОбъект.Комментарий = НСтр("ru = '##Настройка ЭДО помечена на удаление автоматически при обновлении.'", ОбщегоНазначения.КодОсновногоЯзыка());
